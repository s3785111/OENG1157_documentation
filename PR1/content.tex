...
\citetitle{Welch1995} describes the following equations for a linear Kalman filter:
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.75\textwidth]{./img/plot/state/Velocity_X.png}
